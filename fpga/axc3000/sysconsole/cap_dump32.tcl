...
# trigger one small bw_test HyperRAM transaction (LEN=32 words @ BASE=0), and dump the raw 100 MHz
...
# ---- trigger one small HyperRAM transaction: LEN=32 words @ BASE=0 -----------
master_write_32 $m $BW_LEN  32
master_write_32 $m $BW_BASE 0x0
master_write_32 $m $BW_CTRL 0x1
puts "Triggered bw_test run: LEN=32 words, BASE_ADDR=0x00000000"
