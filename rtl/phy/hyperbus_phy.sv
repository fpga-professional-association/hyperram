...
#(
    ...
    parameter int unsigned RD_PREAMBLE_SKIP = 0        // SDR + GENERIC variants: leading rwds-rise edges
                                                       // to ignore as read-strobe preamble (see phy_sdr /
                                                       // phy_generic). ALTERA/XILINX branches ignore it.
) (
    input  logic                clk,
    input  logic                clk90,
    input  logic                clk_ref,
